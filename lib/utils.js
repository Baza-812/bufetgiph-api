...
const F = {
  ...
  ORG_BANK_NAME:  env('FLD_ORG_BANK_NAME',  'BankName'),
  ORG_BANK_INN:   env('FLD_ORG_BANK_INN',   'BankINN'),
  ORG_BANK_KPP:   env('FLD_ORG_BANK_KPP',   'BankKPP'),
  ORG_BANK_ACC:   env('FLD_ORG_BANK_ACC',   'BankAccount'),
  ORG_BANK_BIK:   env('FLD_ORG_BANK_BIK',   'BankBIK'),
  ORG_BANK_CORR:  env('FLD_ORG_BANK_CORR',  'BankCorrespondent'),
