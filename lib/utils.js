...
const ORG_PRICE_FULL = 'PriceFull';  
const ORG_PRICE_LIGHT = 'PriceLight';
// Banks table
const BANK_NAME = 'Name';
const BANK_LEGAL_NAME = 'LegalName';
const BANK_BANK_NAME = 'BankName';
const BANK_INN = 'INN';
const BANK_ACQUIRING_PROVIDER = 'AcquiringProvider';
const BANK_TERMINAL_ID = 'TerminalID';
const BANK_MERCHANT_ID = 'MerchantID';
const BANK_API_KEY = 'APIKey';
const BANK_PAYMENT_PAGE_BASE_URL = 'PaymentPageBaseURL';
const BANK_FOOTER_TEXT = 'FooterText';
const BANK_IS_ACTIVE = 'IsActive';

// Payments table
const PAYMENT_ID = 'PaymentID';
const PAYMENT_ORGANIZATION = 'Organization';
const PAYMENT_EMPLOYEE = 'Employee';
const PAYMENT_AMOUNT = 'Amount';
const PAYMENT_STATUS = 'Status';
const PAYMENT_METHOD = 'PaymentMethod';
const PAYMENT_PROVIDER = 'Provider';
const PAYMENT_EXTERNAL_ID = 'ExternalID';
const PAYMENT_LINK = 'PaymentLink';
const PAYMENT_ORDERS = 'Orders';
const PAYMENT_CREATED_AT = 'CreatedAt';
const PAYMENT_PAID_AT = 'PaidAt';
const PAYMENT_NOTES = 'Notes';
...
const TABLE = {
  ...
  BANKS:      env('TBL_BANKS',      'Banks'), // ✅ исправил отступ
...
const F = {
  ...
  ORG_CUTOFF_TIME: env('FLD_ORG_CUTOFF_TIME', 'Cutoff Time'),
  ORG_BANK:       env('FLD_ORG_BANK',       'Bank'), // ← ДОБАВЬ ЭТУ СТРОКУ (link на Banks)
  ...
  ORDER_PROGRAM:  env('FLD_ORDER_PROGRAM',  'ProgramType'),
  ORDER_TARIFF:   env('FLD_ORDER_TARIFF',   'TariffCode'),
  ORDER_PAYMENT:  env('FLD_ORDER_PAYMENT',  'PaymentMethod'),
  ORDER_PAYMENT_ID: env('FLD_ORDER_PAYMENT_ID', 'PaymentId'),
  ORDER_PAY_LINK: env('FLD_ORDER_PAY_LINK', 'PaymentLink'),
  ...
  // ===== Banks
  BANK_FOOTER: env('FLD_BANK_FOOTER', 'FooterText'), // ✅ уже есть
  };
...
module.exports = {
  ...
  ORG_PRICE_FULL,
  ORG_PRICE_LIGHT,
  ORG_VID_DOGOVORA: 'VidDogovora',
  ORG_BANK: 'Bank',
  ORG_CUTOFF_TIME: 'CutoffTime',
  BANK_NAME,
    BANK_LEGAL_NAME,
    BANK_BANK_NAME,
    BANK_INN,
