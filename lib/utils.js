...
const BANK_CREDENTIALS_SOURCE    = env('FLD_BANK_CREDENTIALS_SOURCE',    'CredentialsSource');
const BANK_ENV_PREFIX            = env('FLD_BANK_ENV_PREFIX',            'ENVPrefix');
