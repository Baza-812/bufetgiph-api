...
module.exports = async (req, res) => {
  try {
    ...
    console.log('[pricing_plan] Using TABLE.ORGS:', TABLE.ORGS);
    console.log('[pricing_plan] Field names:', {
      ORG_ID: F.ORG_ID,
      ORG_NAME: F.ORG_NAME,
      ORG_CONTRACT_TYPE: F.ORG_CONTRACT_TYPE,
      ORG_PRICING_PLAN: F.ORG_PRICING_PLAN,
    });
    ...
    console.log('[pricing_plan] orgResp:', JSON.stringify(orgResp, null, 2));
    ...
    console.log('[pricing_plan] orgRec.fields:', JSON.stringify(orgRec.fields, null, 2));
