...
const F = {
  ...
  OL_UNIT_PRICE: env('FLD_OL_UNIT_PRICE', 'Unit Price'),
  OL_LINE_SUM:   env('FLD_OL_LINE_SUM',   'Line Sum'),
  OL_CHARGE_EMP: env('FLD_OL_CHARGE_EMP', 'Charge To Employee'),
...
module.exports = async (req,res)=>{
  ...
  try{
    ...
    // Unit Price и Line Sum - это formula fields в Airtable, их нельзя устанавливать напрямую
    // Они вычислятся автоматически на основе Item (Menu Item) линка
