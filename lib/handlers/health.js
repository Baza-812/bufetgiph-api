...
const { getPaymentReconcileSecret } = require('../utils');
...
module.exports = async (req, res) => {
  ...
  const reconcileKeyConfigured = !!getPaymentReconcileSecret();
  ...
  res.status(200).json({
    ...
    ref,
    sha,
    /** true, если в этом деплое виден PAYMENT_RECONCILE_KEY или RECONCILE_SECRET */
    reconcile_key_configured: reconcileKeyConfigured,
