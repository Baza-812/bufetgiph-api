...
module.exports = withRateLimit(async (req, res) => {
  ...
  const orgData = {
    ...
    bankName: fields[F.ORG_BANK_NAME] || null,
    bankINN: fields[F.ORG_BANK_INN] || null,
    bankKPP: fields[F.ORG_BANK_KPP] || null,
    bankAccount: fields[F.ORG_BANK_ACC] || null,
    bankBIK: fields[F.ORG_BANK_BIK] || null,
    bankCorrespondent: fields[F.ORG_BANK_CORR] || null,
  };
